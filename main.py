...
if __name__ == '__main__':
    ...
    manager.insert_project((1, "My Project", "Project Description", "http://example.com", 1))
    
    # Получение всех статусов
    print(manager.get_statuses())
    
    # Получение всех проектов пользователя с id=1
    print(manager.get_projects(1))
    
    # Обновление описания проекта
    manager.update_projects("description", ("New Description", 1))
    
    # Удаление проекта
    manager.delete_project(1, 1)
    
    # Удаление навыка из проекта
    manager.delete_skill(1, 1)
